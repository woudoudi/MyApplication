...
public class AppbarZoomBehavior1 extends CoordinatorLayout.Behavior<View> {
    ...
    public AppbarZoomBehavior1(){

    }

    public AppbarZoomBehavior1(Context context, AttributeSet attrs) {
        super(context, attrs);
